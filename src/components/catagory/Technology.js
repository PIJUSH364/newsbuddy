...
function Technology() {
  ...
  const technologyContent = TechnologyContent.map(({...TechnologyContent},index)=>{
    return (
  ...
  return (
    <div className="technology">
      <div className="article-heading">
        {" "}
        <TopicHighlight title="TODAY Technology" subtitle="INOVATON OF STARTUP" />
      </div>
